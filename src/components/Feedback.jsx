      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-8 flex justify-center space-x-6">
            <a href="mailto:contact@example.com" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300">
            ...
            <a href="https://linkedin.com/in/username" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-[#0A66C2] dark:hover:text-[#0A66C2] transition-colors duration-300">
            ...
            <a href="https://github.com/shivansh18" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors duration-300">
