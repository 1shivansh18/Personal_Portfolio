  ...
  const projects = [
    {
      ...
      description:
        "A real-time chat application built using React and Spring Boot. Features include real-time messaging, user authentication, and message history.",
      image: "ChatApp.png",
    ...
    },
    {
      ...
      description:
        "A modern portfolio website showcasing projects and skills. Built with React and Tailwind CSS, featuring smooth animations and responsive design.",
      image: "portfolio.png",
